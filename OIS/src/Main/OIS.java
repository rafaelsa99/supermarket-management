...
public class OIS extends javax.swing.JFrame {
    ...
    //A interface cria uma linha para cada movimento, é preciso mater o track, isto é em que linha está um dado costimer(id)
    ...
    public static int moveManager(JList previous, JList next, int previousIndex, int idCostumer){
        removeCustomerFromInterface(previous, previousIndex);
        return appendCostumerToInterface(next, idCostumer);
    }
        
    public static int moveCashier(JList previous, JList next, int previousIndex, int idCostumer){
        removeCustomerFromInterface(previous, previousIndex);
        return appendCostumerToInterface(next, idCostumer);
    }
    
    public static void removeCashierFromInterface(JList list, int index){
        model = (DefaultListModel)jListPaymentHall.getModel();
        model.remove(index);
    }
    
    public static void removeCustomerFromInterface(JList list, int idCostumer){
        model = (DefaultListModel)list.getModel();
        model.removeElementAt(idCostumer);
    }
    ...
    public static JList[] corridor1 = new JList[]{ jListCorridor10, jListCorridor11, jListCorridor12, jListCorridor13, jListCorridor14, jListCorridor15, jListCorridor16, jListCorridor17, jListCorridor18, jListCorridor19};
    public static JList[] corridor2 = new JList[]{ jListCorridor20, jListCorridor21, jListCorridor22, jListCorridor23, jListCorridor24, jListCorridor25, jListCorridor26, jListCorridor27, jListCorridor28, jListCorridor29};
    public static JList[] corridor3 = new JList[]{ jListCorridor30, jListCorridor31, jListCorridor32, jListCorridor33, jListCorridor34, jListCorridor35, jListCorridor36, jListCorridor37, jListCorridor38, jListCorridor39};
